...
from picc_llm.visualizations import visualizations
...
def generate_conditions(user_index: int) -> tuple:
    ...
    # Balanced study condition assignment
    condition_count = {"ai": 0, "baseline": 0}
    for u in User.query.all():
        if u.study_condition in condition_count:
            condition_count[u.study_condition] += 1
    study_condition = weighted_selection(condition_count)
