...
"""
picc_llm.app.learning_handler
============================

Handles training for webapp
...
from picc_llm.app.models import User, Learning
...
class LearningHandler:
    ...
    def set_in_progress(self) -> None:
        ...
        self.learner.progress_current = 0
        db.session.commit()
    ...
    def train(self, user_params: Any) -> None:
        ...
        app.logger.debug(f"User {self.user_index}: user_params={user_params}")
        ...
        training_progress = {
            ...
            "target_max_reward": target_max_reward,
