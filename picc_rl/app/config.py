...
class Config:
    ...
    TRAINING_CONFIG = {
        ...
        "K_epochs": 10,
        "eps_clip": 0.2,
        "train_with_random_configs": False,
    }
    ...
    LLM_SETTINGS = {
            ...
            "prompts": {
                "system_prompt": (
                    "You are an expert Curriculum Designer for Reinforcement Learning agents learning 'MicroMinecraft'.\n"
                    "GOAL: Craft a Pogo Stick (2 Wood + 1 Stone + 1 Iron).\n"
                    "MECHANICS: Wood(Tree), Stone(Rock), Iron(Ore+Furnace). Ore requires Pickaxe(Chest).\n"
                ...
                "initial_pipeline": [
                    {
                        "name": "plan",
                        "prompt": (
                            "This is the FIRST stage. Design a curriculum roadmap.\n"
                            "1. Outline a strategy for 5 stages (e.g., 'Gathering' -> 'Crafting').\n"
                            "2. Determine parameters for Stage 1. It should be solvable but simple.\n"
                    ...
                    },
                    {
                        "name": "generate",
                        "prompt": (
                            "Generate the configuration for STAGE 1. "
                            "Grid: 6x6 to 15x15. Provide counts for TREE, ROCK, CRAFT_TABLE, FURNACE, IRON_ORE, CHEST."
                        )
                    }
                ],
                ...
                "continuous_pipeline": [
                    {
                        ...
                        "prompt": (
                            ...
                            "If success > 0.8, increase difficulty. If < 0.3, simplify. "
                            "Did the user modify your previous suggestion? Adapt to their preference."
                        )
                    },
                    {
                        "name": "generate",
                        "prompt": "Generate the configuration for Stage {current_stage}."
                    }
                ]
            }
        }
